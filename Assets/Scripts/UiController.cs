...
public class UiController : MonoBehaviour
{
    ...
    [FormerlySerializedAs("moneyValue")] public TextMeshProUGUI _moneyValue;
    [FormerlySerializedAs("populationValue")] public TextMeshProUGUI _populationValue;
    ...
    {
        _populationValue.text = population + "";
    }
